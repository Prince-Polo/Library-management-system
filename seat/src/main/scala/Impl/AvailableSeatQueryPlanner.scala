...
import APIs.SeatAPI.{AvailableSeatQueryMessage, AvailableSeatQueryResponse}
import Common.SeatInfo
import Common.SeatStatus
import Common.SeatStatus.SeatStatus // 导入 SeatStatus

case class AvailableSeatQueryPlanner(message: AvailableSeatQueryMessage, override val planContext: PlanContext) extends Planner[String] {
