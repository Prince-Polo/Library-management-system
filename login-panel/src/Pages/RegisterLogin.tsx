...
export function StudentLogin() {
    ...
    return (
        <div style={{ background: 'white', opacity: '90%' }}>
                <RegisterLoginForm title="Student Login" fields={fields} createMessage={createMessage} />
        </div>
    );
}
...
export function AdminRegister() {
    ...
    return (
        <div style={{ background: 'lightcyan', opacity: '90%', color: '#8B4513' }}>
            <RegisterLoginForm title="Administrator Register" fields={fields} createMessage={createMessage} />
        </div>
    );
}
...
export function AdminLogin() {
    ...
    return (
        <div style={{ background: 'lightyellow', opacity: '90%', color: '#8B4513' }}>
            <RegisterLoginForm title="Administrator Login" fields={fields} createMessage={createMessage} onSuccess={handleSuccess} />
        </div>
    );
}
