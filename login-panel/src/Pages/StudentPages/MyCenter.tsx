...
import { DeleteAccountModal } from 'Pages/StudentPages/DeregisterModal';
import { UpdateInfoModal } from 'Pages/StudentPages/UpdateInfoModal';
import { ReservationPane } from 'Pages/StudentPages/ReservationPane';
        ...
        <div style={backgroundStyle}>
            <div style={overlayStyle}>
                <div style={boxStyle}>
                    ...
                    <div style={reservationPaneStyle}>
...
const reservationPaneStyle: React.CSSProperties = {
    width: '100%',
    marginBottom: '20px',
};
